<%-- 
    Document   : update
    Created on : Nov 5, 2018, 1:18:45 PM
        ...
        <form action="membership" method="post" onsubmit="return validateForm()">  <!--Change Registration in this line to give another page submission -->
            ...
            <table class="SignupForm">
                ...
                <tr>
                    ...
                    <td><input type="email" class="FormInput" name="email" value="<c:out value='${user.email}' />" readonly="readonly"><span id="email_error" class="notVisible">*</span><br> </td>
                </tr>
                
                <tr>
                    <td> <label class="FormElement">Username:</label> </td>
                    <td> <input type="text" class="FormInput" name="userName" value="<c:out value='${user.userName}' />" readonly="readonly"><span id="userName_error" class="notVisible">*</span><br> </td>
                </tr>
                ...
                <tr>
                    <td> <input type="submit" class="FormInputSubmit" name="registerAcct" value="Update"><br> </td>
                </tr>
            </table>
        </form>
        </div>
